// GitHub brand mark vendored from Font Awesome Free 7.3.0
// (https://fontawesome.com, icons licensed CC BY 4.0) rather than pulling in
// the @fortawesome packages for a single glyph.
